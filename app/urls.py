...
urlpatterns = [
    ...
    path('api/onesignal_notification/', views.OnesignalNotification.as_view()),
    ...
    path('api/visitorsByResidence/', views.VisitorsByResidence.as_view(actions={'get': 'list'})),
    ...
    path('api/agentsByResidence/', views.AgentsByResidence.as_view(actions={'get': 'list'})),
    path('api/index', views.home, name='home'),
]
